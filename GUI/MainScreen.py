...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LapRecordList.setFont(font)
        ...
        self.gridLayout.addWidget(self.LapRecordList, 0, 0, 6, 1)
...
"background-color: rgb(171, 183, 183);")
        ...
        self.gridLayout.addWidget(self.StartTimerBtn, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.LapTimeLbl, 3, 2, 1, 5)
        ...
        self.gridLayout.addWidget(self.StopTimerBtn, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.ConfigBtn, 5, 6, 1, 1)
